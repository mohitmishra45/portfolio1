            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 w-full overflow-hidden">
                ...
                >
                    ...
                    <p className="text-secondary max-w-2xl mx-auto text-lg">
                        A specialized toolkit focused on Data Science, Machine Learning, and Modern Architectures.
                    </p>
                </motion.div>

                {/* Skills Triangle Layout */}
                            ...
                            {row.map((skill, sIdx) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        // Dynamic sizing to fit nicely side-by-side
